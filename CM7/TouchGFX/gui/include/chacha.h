...
#define NONCE_SIZE 3
#define NUM_ROUNDS 20 // jest 20, bo uzywaja 20 rund w specyfikacji
...
//void encrypt(unsigned char *plaintext, unsigned int plaintext_len, unsigned long *key, unsigned long *nonce, unsigned char *ciphertext);
